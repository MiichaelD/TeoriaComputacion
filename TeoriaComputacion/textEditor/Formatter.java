...
final static int WIDTH = 400;
  ...
  StyledDocument doc;  //  @jve:decl-index=0:
  JTextPane pane;
  JLabel statusInfo;
      ...
      Thread appThread = new Thread() {
        public void run() {
          try {
             ...
             public void run() {setCursor (Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));}});
          } catch (Exception e) {
            e.printStackTrace();
          }
        }
  ...
  public void doFontCommand() {
    Font font = null;// = FontChooser.ask (this, "Change font", getFont(), null);
    if (font != null) {
